...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable
{
    ...
    public static Location maximize2D(final Location center, final double radius) {
        return new Location(center.getWorld(), center.getX() + radius, center.getY(), center.getZ() + radius);
    }
    
    public static Location minimize2D(final Location center, final double radius) {
        return new Location(center.getWorld(), center.getX() - radius, center.getY(), center.getZ() - radius);
    }
    ...
    public Cuboid(final Location center, final double radius) {
        this(maximize2D(center, radius), minimize2D(center, radius));
    }
    ...
    public List<Block> getLayer(final int y) {
        final List<Block> layerBlocks = new ArrayList<Block>();
        for (final Block block : this) {
            if (block.getY() == y) {
